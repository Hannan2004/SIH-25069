...
export default function ResultsPage() {
  ...
  const generatePdfFromAnalysis = useCallback(async () => {
    ...
    try {
      ...
      console.log(
        "Generating professional PDF with embedded charts and ISO compliance..."
      );
      ...
      console.log(
        "Professional PDF ready with ISO compliance and embedded charts"
      );
      ...
      <Section>
        ...
        <Card className="p-6 mb-12">
          <h3 className="font-semibold mb-3">
            Professional Technical Report PDF
          </h3>
          <div className="mb-3">
            <div className="flex flex-wrap gap-2 text-xs">
              <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded">
                ISO 14044:2006 Compliant
              </span>
            ...
            <div className="space-y-3">
              ...
              {autoGenerated && (
                <p className="text-xs text-gray-600">
                  Generated with embedded charts, ISO compliance badges, and
                  professional branding.
                </p>
              )}
            </div>
...
function BeforeAfterCombinedChart() {
  return (
    <ResponsiveContainer width="100%" height={280}>
      ...
      <BarChart
        data={combinedData}
        margin={{ top: 40, right: 10, left: 8, bottom: 0 }}
      >
        ...
        {combinedData.map((entry, index) => {
          const reduction = (
            ((entry.before - entry.after) / entry.before) *
            100
          ).toFixed(0);
          ...
          const xPosition =
            CHART_LEFT_MARGIN + (index / (totalItems - 1)) * CHART_USABLE_WIDTH;
