  ...
  const usps = [
    {
      ...
      description:
        "Grid mix, transport patterns, and scrap flows tailored for Indian industrial conditions",
    },
    {
      icon: Cpu,
      title: "AI Gap Filling",
      description:
        "Machine learning for parameter estimation and document extraction from technical reports",
    },
    {
      icon: Award,
      title: "Compliance-First",
      description:
        "ISO 14040/44 methodology with EPD-ready outputs for regulatory submission",
    },
    {
      icon: Recycle,
      title: "Circularity Metrics",
      description:
        "Track recycled content, end-of-life rates, and closed-loop material flows",
    },
  ];
  ...
  const features = [
    {
      ...
      title: "Upload & Edit",
      description:
        "XLSX/CSV import with inline editing and ML-assisted gap filling",
    },
    {
      icon: BarChart3,
      title: "Scenario Comparison",
      description:
        "Compare conventional vs circular pathways with detailed impact analysis",
    },
    {
      icon: Download,
      title: "Report Generation",
      description:
        "Professional PDF reports with Sankey diagrams and compliance documentation",
    },
  ];
